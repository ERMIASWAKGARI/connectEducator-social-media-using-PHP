        ...
        <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?signup">
                <div class="d-flex justify-content-center">
                    ...
                    <img class="mb-4" src="assets/images/connect_educator.jpg" alt="" width="100%" height="45">
                </div>
                <h1 class="h5 mb-3 fw-normal" style="text-align:center; font-family: Your Custom Font, Arial, sans-serif; ">Create new account</h1>
                <div class="d-flex">
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="?login" class="text-decoration-none btn btn-primary">Already have an account ?</a>
