...
elseif(isset($_GET['signup'])){
    showPage('header',['page_title'=>'ConnectEducator - SignUp']);
    showPage('signup');
}
...
elseif(isset($_GET['login'])){
    ...
    showPage('header',['page_title'=>'ConnectEducator - Login']);
    showPage('login');
}
...
elseif(isset($_GET['forgotpassword'])){
    ...
    showPage('header',['page_title'=>'ConnectEducator - Forgot Password']);
